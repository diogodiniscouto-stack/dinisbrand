...
const items = [
  {
    ...
    desc: "Answer the honest questions before you invest a single euro.",
  ...
  },
  {
    ...
    desc: "The whole path from zero to first sale, on one visual page.",
  ...
  },
  {
    ...
    desc: "Score your idea before you spend a cent on it.",
  ...
  },
  {
    ...
    desc: "The exact tools I use to find products, suppliers and competitors.",
